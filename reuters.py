# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 19:54:55 2019
...
class ReutersParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == "reuters":
            ...
            self.in_topics = True
        elif tag == "d" and self.in_topics == True:
...
def filter_doc_list_through_topics(topics, docs):
    ...
    a list of topics. It cleans the text and cross-checks the topis from 
    topics list given in the dataset.
...
#classif = OneVsRestClassifier(GaussianNB()).fit(X,y)
